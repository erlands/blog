    ...
    <div id="slideIndicators" class="carousel slide" data-ride="carousel" data-interval="3000" data-pause="">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active"
                 style="background-image: url('http://118.190.210.159/group1/M00/00/00/rB_qBl4AOBGACXxpAAD_IetA0tc804_big.jpg')">
            ...
            <div class="carousel-item"
                 style="background-image: url('http://118.190.210.159/group1/M00/00/00/rB_qBl4Ap0KAII4UABDAx1DN22c252_big.png')">
                <div class="carousel-caption d-none d-md-block">
